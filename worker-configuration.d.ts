/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 843adfc90bc80b11cfc814179ffcf010)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 nodejs_compat
interface __BaseEnv_Env {
	JOB_LOBSTER_DB: D1Database;
	AI: Ai;
	ASSETS: Fetcher;
	ALLOWED_ORIGINS: "https://job-lobster-globe.pages.dev,http://localhost:5174,http://127.0.0.1:5174";
	AGENT_INSTANCE_NAME: "production";
	TITLE_AI_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	JOB_DISCOVERY_AGENT: DurableObjectNamespace<import("./src/worker/index").JobDiscoveryAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "JobDiscoveryAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "AGENT_INSTANCE_NAME" | "TITLE_AI_MODEL">> {}
}
